				...
				<VersusContainer>
					...
					<Options>
						<VersusItem>
							<StyledContent>
								<InfluencerContainer>
									<Picture src={battle.pers1.picture} />
									<InfoBlock>
										<SubTitle>{battle.pers1.name}</SubTitle>
										<Text>{battle.pers1.handle}</Text>
									</InfoBlock>
								</InfluencerContainer>
								<StatBlock>
									<SubTitle>Bio</SubTitle>
									<Text>{battle.pers1.bio}</Text>
								</StatBlock>
								<StatBlock>
						...
						<VersusItem>
							<StyledContent>
								<InfluencerContainer>
									<Picture src={battle.pers2.picture} />
									<InfoBlock>
										<SubTitle>{battle.pers2.name}</SubTitle>
										<Text>{battle.pers2.handle}</Text>
									</InfoBlock>
								</InfluencerContainer>
								<StatBlock>
									<SubTitle>Bio</SubTitle>
									<Text>{battle.pers2.bio}</Text>
								</StatBlock>
								<StatBlock>
									<SubTitle>Followers</SubTitle>
