...
import Pool3 from "../Battle/electionbattles/Pool3";
import useFarms from "../../hooks/useFarms";
import { getWarStaked, getChessContracts, getCurrentBets, chessTVL } from "../../yamUtils";
import { getStats } from "../Battle/electionbattles/utils";

import Uniswap from "../../../assets/img/uniswap@2x.png";
import BetModalElection from "../Battle/electionbattles/RedeemCardElection"
...
import ChessVotingBalance from "./ChessVotingBalance";
...
const Results: React.FC = () => {
  ...
  return (
    <>
      {roughBets.trump > 0 &&
        <ChessVotingBalance votes1={roughBets.trump} votes2={roughBets.biden} />
      }
    <Container>
      <VersusContainer>
        <VersusBackground>
